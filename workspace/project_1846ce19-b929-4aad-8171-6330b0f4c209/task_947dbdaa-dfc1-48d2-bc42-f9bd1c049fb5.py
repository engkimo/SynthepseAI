task_info = {
    "task_id": "947dbdaa-dfc1-48d2-bc42-f9bd1c049fb5",
    "description": "Visualize the data and analysis results using graphs, such as line charts for stock trends, histograms for distribution, etc.",
...
def run_task():
    ...
    try:
        ...
        def run_task():
            ...
            try:
                result = None
                # Replace this with actual task execution code
                if result is None:
