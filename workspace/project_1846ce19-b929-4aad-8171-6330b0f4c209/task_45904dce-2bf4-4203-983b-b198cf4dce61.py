task_info = {
    "task_id": "45904dce-2bf4-4203-983b-b198cf4dce61",
    "description": "Perform exploratory data analysis (EDA) to understand the distribution and patterns in the data.",
...
def run_task():
    ...
    try:
        ...
        def run_task():
            ...
            try:
                result = None
                # {main_code} should be replaced with actual task execution code if needed
                if result is None:
