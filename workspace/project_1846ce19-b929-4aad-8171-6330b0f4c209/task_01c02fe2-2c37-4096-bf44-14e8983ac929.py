task_info = {
    "task_id": "01c02fe2-2c37-4096-bf44-14e8983ac929",
    "description": "Interpret the visualized results and summarize the findings.",
...
def run_task():
    ...
    try:
        ...
        # 必要なライブラリのインポート
        # {imports}  # This line should be removed or replaced with actual imports if needed
        import os
        import json
        import time
        import re
        ...
        def run_task():
            ...
            try:
                result = None
                # {main_code}  # This line should be replaced with actual task execution code
                if result is None:
