task_info = {
    "task_id": "0928ca1a-4620-4d95-bbb3-aa346e738c8c",
...
def run_task():
    ...
    try:
        ...
        log_thought("task_mock", {"task": "目標「2024年のプライム上場企業のデータ分析して可視化」の初期分析を行う"})
        add_insight("モック: 目標「2024年のプライム上場企業のデータ分析して可視化」の初期分析を行う の初期分析", 0.7)
        result = "モック実行: 目標「2024年のプライム上場企業のデータ分析して可視化」の初期分析を行う が完了しました"
        if result is None:
