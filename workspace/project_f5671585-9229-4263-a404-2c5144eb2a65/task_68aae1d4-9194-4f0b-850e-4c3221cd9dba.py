...
def main():
    ...
    try:
        ...
        task_info = {
            "task_id": "68aae1d4-9194-4f0b-850e-4c3221cd9dba",
            "description": "Fetch the historical stock data for the Japanese stock market index (e.g., Nikkei 225) using an appropriate API.",
