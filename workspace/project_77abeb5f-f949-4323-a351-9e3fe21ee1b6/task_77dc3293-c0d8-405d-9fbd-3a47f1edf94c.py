...
def main():
    ...
    try:
        ...
        task_info = {
            "task_id": "77dc3293-c0d8-405d-9fbd-3a47f1edf94c",
            "description": "Preprocess the stock data: handle missing values, clean data, and convert date columns to appropriate format.",
