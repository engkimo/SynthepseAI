...
def main():
    ...
    try:
        ...
        task_info = {
            "task_id": "da4012c0-a28a-4d73-99ec-f816dfdd5df7",
            "description": "Summarize the findings and insights from the analysis, including any significant trends or anomalies observed.",
