...
def main():
    ...
    try:
        ...
        task_info = {
            "task_id": "11a24b4d-590c-487c-ae10-8916b99edd26",
            "description": "Fetch historical stock data for the Nikkei 225 index using yfinance.",
            "plan_id": "f6ffd5b2-ee2e-4d41-a887-cb0482635ecc",
        }
        ...
        def main():
            ...
            try:
                ...
                result = fetch_nikkei_data()
                if result is not None:
                    print("Nikkei 225 historical data fetched successfully.")
                else:
                    print("Failed to fetch Nikkei 225 historical data.")
                ...
                return result if result is not None else "Task completed with errors"
