...
def main():
    ...
    try:
        ...
        task_info = {
            "task_id": "44eed5a6-ecd0-4614-9dcd-9daacadff9ac",
            "description": "Preprocess the data by handling missing values and ensuring the data types are appropriate for analysis.",
