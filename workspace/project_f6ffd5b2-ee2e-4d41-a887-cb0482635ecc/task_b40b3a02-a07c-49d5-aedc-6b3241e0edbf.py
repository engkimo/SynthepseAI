...
def main():
    ...
    try:
        ...
        task_info = {
            "task_id": "b40b3a02-a07c-49d5-aedc-6b3241e0edbf",
            "description": "Calculate key statistical metrics such as mean, median, and standard deviation of the stock prices.",
