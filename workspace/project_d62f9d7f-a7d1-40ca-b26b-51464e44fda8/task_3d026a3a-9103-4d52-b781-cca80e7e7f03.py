...
def prepare_task():
    ...
    try:
        ...
        task_info = {
            "task_id": "3d026a3a-9103-4d52-b781-cca80e7e7f03",
            "description": "Perform basic statistical analysis on the stock price data, such as calculating mean, median, and standard deviation.",
