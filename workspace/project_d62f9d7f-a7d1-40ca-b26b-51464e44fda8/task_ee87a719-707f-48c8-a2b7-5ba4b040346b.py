...
def prepare_task():
    ...
    try:
        ...
        task_info = {
            "task_id": "ee87a719-707f-48c8-a2b7-5ba4b040346b",
            "description": "Fetch historical stock price data for Japanese stocks, such as the Nikkei 225, from a reliable financial API.",
