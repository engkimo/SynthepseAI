...
def prepare_task():
    ...
    try:
        ...
        task_info = {
            "task_id": "5bca6bde-1dc0-4f81-ba73-b6cbf857b2a8",
            "description": "Handle any potential errors in data fetching, preprocessing, or visualization, ensuring robustness.",
